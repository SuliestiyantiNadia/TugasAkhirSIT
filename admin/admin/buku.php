            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <section class="content">
                  ...
                  <thead>
                    ...
                    <tbody>
                    <tr>
                    <td><a href="404.php?hal=edit&kd=<?php echo $data['id_buku'];?>"><span class="fa fa-book"></span> <?php echo $data['id_buku']; ?></a></td>
              ...
              ?>
                  ...
                  <?php $tampil=mysql_query("select * from buku order by id_buku");
