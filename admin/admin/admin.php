            ...
            <nav class="navbar navbar-static-top" role="navigation">
              ...
              <div class="navbar-right">
                ...
                <section class="content">
	               ...
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM user
	               where username like '%$qcari%'
	               or password like '%$qcari%'  ";
                    }
                  ...
                  <thead>
                    ...
                    <td><a href="detail-admin.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-user"></span> <?php echo $data['username']; ?></a></td>
                   <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Admin" href="edit-admin.php?hal=edit&kd=<?php echo $data['uid'];?>"><span class="glyphicon glyphicon-edit"></span></a>
